...
struct ZipPanel : public wxPanel
{
    ...
    void InitializeDirectoryLoadSection();
    void InitializeFileListSection();
    void InitializeCompressSection();
...
ZipPanel::ZipPanel(wxWindow *parent) : wxPanel(parent)
{
    ...
    InitializeDirectoryLoadSection();
    InitializeFileListSection();
    InitializeCompressSection();

    SetSizer(mainSizer);
}

void ZipPanel::InitializeDirectoryLoadSection()
{
...
void ZipPanel::InitializeFileListSection()
{
...
void ZipPanel::InitializeCompressSection()
{
...
void ZipPanel::ExecuteCompression()
{
